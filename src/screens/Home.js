...
import { StyleSheet, Text, View, TextInput, FlatList,Dimensions, Image, TouchableOpacity, StatusBar } from 'react-native'
...
const Home = ({navigation}) => {
    ...
    const [carpetService, setCarpetService] = useState([
        ...
        {key: 5, name: 'Hardwood Floor Cleaning', photo: Images.HARDWOOD_FLOOR_CLEANING},
        {key: 6, name: 'Flooring Installation', photo: Images.FLOORING_INSTALLATION},
    ])
        ...
        <View style={styles.container}>
            ...
            <View style={styles.containerHeader}>
                <View style={styles.addressInput}>
                    ...
                    />
                    <Text style={styles.textBold}>330 Amity Rd, Woodbridge, CT, 06525</Text>
                </View>
                <View style={styles.searchInput}>
                    ...
                    />
                    <TextInput style={styles.inputSearch} placeholder="Search for services and packages"/>
                </View>
